                    ...
                    children: [
                      ...
                      widget.customBottomWidget ??
                          Input(
                            ...
                            onNotificationSendPressed: widget.onNotificationSendPressed,
                            onVoteSendPressed:widget.onVoteSendPressed, username: widget.user.firstName ?? 'Null',
                          ),
                    ],
                  ),
                ),
      ...
      if (message is types.SystemMessage) {
        ...
        final messageWidth = message.type != types.MessageType.custom ?
            widget.showUserAvatars && message.author.id != widget.user.id
                ...
                : min(constraints.maxWidth * 0.78, 440).floor() : min(constraints.maxWidth * 0.85, 640).floor();
